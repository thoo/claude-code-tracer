...
from claude_code_tracer.models.entries import TokenUsage
from claude_code_tracer.services.database import get_or_create_session_view, _session_views, invalidate_session_view
...
def complex_project_structure(mock_projects_dir):
    ...
    for i in range(3):
        ...
        with open(session_path, "w") as f:
            ...
            f.write(f'{{"type": "assistant", "message": {{"id": "msg-{i}-1", "model": "claude-3-5-sonnet", "usage": {{"input_tokens": 100, "output_tokens": 50, "cache_creation_input_tokens": 0, "cache_read_input_tokens": 0}}}}, "timestamp": "2024-01-01T12:00:00Z"}}\n')
            ...
            with open(agent_path, "w") as af:
                af.write(f'{{"type": "assistant", "message": {{"id": "sub-{i}-1", "model": "claude-3-haiku", "usage": {{"input_tokens": 50, "output_tokens": 25, "cache_creation_input_tokens": 0, "cache_read_input_tokens": 0}}}}, "timestamp": "2024-01-01T12:00:05Z"}}\n')

    # Create another project
    other_project = mock_projects_dir / "other-project"
    other_project.mkdir()
    with open(other_project / "sess-other.jsonl", "w") as f:
         f.write('{"type": "assistant", "message": {"id": "msg-other", "model": "claude-3-opus", "usage": {"input_tokens": 200, "output_tokens": 100, "cache_creation_input_tokens": 0, "cache_read_input_tokens": 0}}, "timestamp": "2024-01-02T12:00:00Z"}\n')
...
def test_session_view_caching(complex_project_structure):
    ...
    view_name3 = get_or_create_session_view(session_path)
    assert str(session_path) in _session_views
